...
public class GraphQLFunction {
          ...
          RuntimeWiring wiring = RuntimeWiring.newRuntimeWiring()
            ...
            .type(TypeRuntimeWiring.newTypeWiring("Mutation")
              .dataFetcher("createProduct", env -> {
                ...
                Store.Product p = mapToProduct(in);
              ...
              .dataFetcher("updateProduct", env -> {
                String id = env.getArgument("id");
                Map<String,Object> in = env.getArgument("input");
                Store.Product upd = mapToProduct(in);
              ...
              .dataFetcher("deleteProduct", env -> {
                ...
                // borra edges relacionados a producto
                Store.EDGES.removeIf(e -> id.equals(e.productId));
                return removed;
              })

              .dataFetcher("createWarehouse", env -> {
                Map<String,Object> in = env.getArgument("input");
                Store.Warehouse w = mapToWarehouse(in);
              ...
              .dataFetcher("updateWarehouse", env -> {
                String id = env.getArgument("id");
                Map<String,Object> in = env.getArgument("input");
                Store.Warehouse upd = mapToWarehouse(in);
              ...
              .dataFetcher("link", env -> {
                ...
                boolean ok = !Store.EDGES.contains(new Store.Edge(productId, warehouseId))
                          && Store.EDGES.add(new Store.Edge(productId, warehouseId));
  ...
  private static Store.Product mapToProduct(Map<String,Object> in){
    Store.Product p = new Store.Product();
    ...
    p.setPrice(price==null?0.0: Double.parseDouble(String.valueOf(price)));
    return p;
  }

  private static Store.Warehouse mapToWarehouse(Map<String,Object> in){
    Store.Warehouse w = new Store.Warehouse();
